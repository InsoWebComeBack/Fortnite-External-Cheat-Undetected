...
{
	const std::string cchars = XorStr(".sys").c_str();

	std::string random_driver_string(const int len);
	const std::string testing = random_driver_string(10) + cchars.c_str();

	const auto driver_name = testing.c_str();
